    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                {!! Form::Select('type',array('generic'=>'Generic','dosage'=>'Dosage/Medicine Type','medicine'=>'Medicine','manufacturer'=>'Manufacturer'),null, ['required'=>'required','class' => 'select form-control', 'placeholder' => trans('import.select_type')]) !!}
                @if ($errors->has('type'))
