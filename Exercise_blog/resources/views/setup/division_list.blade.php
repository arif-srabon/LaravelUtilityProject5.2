...
@section('content')
    ...
    <script type="application/javascript">
        ...
        /*function onError(e) {
            ...
            if (e.errors == 'createFailed') {
                toastr["error"]("{!!config('app_config.msg_duplicate')!!}", "Created Failed");
            } else if (e.errors == 'updateFailed') {
                toastr["error"]("{!!config('app_config.msg_duplicate')!!}", "Updated Failed");
            } else if(e.errors == 'required6'){
                toastr["error"]("Geo Code Maximum 6 character", "Required");
            }else {
...
//            return false;
        ...
        function commandPermission(e) {
            ...
            window.location.href = '/division/' + dataItem.id + '/edit/';
        }
