...
$(document).ready(function(){
    var theme_swithcer = $('#sidebar-theme-switcher .btn');

    theme_swithcer.on('click', function(){
        theme_swithcer.removeClass('active');

        var this_elem = $(this),
            radio_val = $(this).find('input[type="radio"]');
        ...
        else if(radio_val.val() === 'violet') {
            window.location.replace('/setColor/violet');
        }
        else if(radio_val.val() === 'blue') {
            window.location.replace('/setColor/blue');
        }
        else {
            window.location.replace('/setColor/light-green');
        }
